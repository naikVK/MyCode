  ...
  <div id="registerationForm" class="columns">
    ...
    <div class="field">
      ...
      <div class="control is-expanded">
        <input class="input" @keyup.enter="trigger" ref="txt_fullname" type="text" v-validate="'required'" name="fullname" v-model="signUpForm.personalDetails.fullName" :placeholder="$t('registration.placeholder.fullname')">
      </div>
      ...
      <div class="control has-icons-left">
        <input class="input" @keyup.enter="trigger" type="date" id="dobCalendar" v-validate="'required'" name="dob" v-model="signUpForm.personalDetails.dob">
    ...
    <div class="field">
      ...
      <div class="control">
        <label class="radio">
          <input type="radio" @keyup.enter="trigger" v-validate="'required'" v-model="signUpForm.personalDetails.gender" value="M" name="gender">
          {{ $t('registration.gender_male') }}
        </label>
        <label class="radio">
          <input type="radio" @keyup.enter="trigger" v-validate="'required'" v-model="signUpForm.personalDetails.gender" value="F" name="gender">
    ...
    <div class="field">
      ...
      <div class="control has-icons-left has-icons-right">
        <input @keyup.enter="trigger" v-validate="'required|email'" :class="{'input': true}" name="email" type="email"   v-model="signUpForm.contactDetails.email.address" :placeholder="$t('registration.placeholder.email')">
    ...
    <div class="field">
      ...
      <div class="control has-icons-left has-icons-right">
        <input class="input" @keyup.enter="trigger" type="text" id="txt_mobNo" @focusout="mobileNoChanged" v-validate="'required|digits:10'" name="mobile" v-model="signUpForm.contactDetails.mobile.number" :placeholder="$t('registration.placeholder.mobile')">
        <span class="icon is-small is-left">
    ...
    <div class="field">
      ...
      <div class="control is-expanded has-icons-left has-icons-right">
        <input @keyup.enter="trigger" :class="{'input' : true, 'is-success': !errors.has('username')&& isUsernameAvailable}" type="text" @focusout="checkUsernameAvailability" v-validate="'required'" name="username" v-model="signUpForm.userName" :placeholder="$t('registration.placeholder.username')">
        <span class="icon is-small is-left">
    ...
    <div class="field">
      ...
      <div class="control has-icons-left column is-four-fifths">
        <input :class="{'input': true}" id="txt_password" @keyup.enter="trigger" type="password" name="password" v-validate="'required'" @keypress="passwordChanged" v-model="signUpForm.password" :placeholder="$t('registration.placeholder.password')"/>
